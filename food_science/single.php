  ...
  <main>
    <!-- <?php if (have_posts() ): ?>
      <?php while (have_posts() ): the_post(); ?>
          ...
          <footer class="post_footer">
            ...
            <div class="category">
              <div class="category_list">
               ...
               <div class="category_item"><a href="<?php echo get_the_category_link($category); ?>" class="btn btn-sm is-active"><?php echo $category->name; ?></a></div>
               <?php endforeach; ?>
              </div>
              </div>
              <?php endif; ?> -->
            ...
            <div class="prevNext">
              <!-- <?php $previous_post=get_previous_post(); if ($previous_post): ?>
        ...
        <?php endwhile; ?>
        <?php endif; ?> -->
        <!-- <?php $args = ['post_type'=>'post', //投稿記事だけを指定
        ...
        <section class="latest">
          <header class="latest_header">
            <h2 class="heading heading-secondry">新着情報</h2>
        </header>
